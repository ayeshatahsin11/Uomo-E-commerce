  ...
  return (
    <>
      <Tabs defaultValue="Best Sellers">
        <div className="absolute top-2.75 right-0">
          <TabsList variant="line">
            <TabsTrigger className="..." value="Best Sellers">Best Sellers</TabsTrigger>
            <TabsTrigger className="..." value="Most Popular">Most Popular</TabsTrigger>
            <TabsTrigger className="..." value="Top 20">Top 20</TabsTrigger>
            <TabsTrigger className="..." value="Best Rated">Best Rated</TabsTrigger>
          </TabsList>
        </div>
